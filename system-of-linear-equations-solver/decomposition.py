...
class Decomposition(Matrix):
    """Decompose matrix A in to L and U matricies."""
    ...
    def __init__(self, values):
        ...
        Access L/U via l() and u()
        """
        # super().__init__(m, n)
        m, n = len(values), len(values[0])
        # TODO: merge into 1 matrix
    ...
    def l(self, i, j):
        """Matrix L from values."""
        # Main diagonal
        if i == j:
            return 1

        # Higher than main diagonal
        if i < j:
            return 0
